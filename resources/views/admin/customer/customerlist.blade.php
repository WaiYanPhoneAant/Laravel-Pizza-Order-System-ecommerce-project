    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">    
            <div class="col-md-12">
                ...
                <form class="form-header mb-3" action="{{route('customer#list')}}" >
                    @csrf
                ...
                <div class="float-md-end float-center my-md-2">
                    <h4>
                        {{ request('search')? 'Search ':'Total '  }}data founds- ({{$users->total()}})</h4>
                    </div>
                                                    ...
                                                    <dialog id="role-{{$a->id}}" class="m-auto border-0 shadow" >
                                                        ...
                                                        <div class="p-4">
                                                            <div class="modal-body">
                                                                <h4 class="mb-3">Are you sure to Change <span class="text-primary" >{{$a->name}}</span> to Admin</h4>
        ...
        <script> 
            ...
            $(document).ready(function () {
                ...
                $('.changeAdmin').click(function(){
                    ...
                    $parentNode.find('.changeUser').html('<i class="fa-solid fa-user-shield me-2"></i> Admin');
                    console.log($role);
                    $('#role-'+$userId).hide(); 
                    $.ajax({
                        type:'get',
