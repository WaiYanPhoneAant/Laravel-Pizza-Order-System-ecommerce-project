                     ...
                     <div class="card-body">
                       ...
                       <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                @endif
                                <h5 class="my-3"><i class="fa-solid fa-user-pen me-2"></i> {{Auth::user()->name}}</h5>
                                <h5 class="my-3"><i class="fa-regular fa-envelope me-2"></i> {{Auth::user()->email}}</h5>
                                <h5 class="my-3"><i class="fa-solid fa-phone me-2"></i> {{Auth::user()->phone}}</h5>
                                <h5 class="my-3"><i class="fa-solid fa-location-dot me-2"></i> {{Auth::user()->address}}</h5>
                                <h5 class="my-3"><i class="fa-solid fa-person-half-dress me-3"></i>{{Auth::user()->gender}}</h5>
                                <h5 class="my-3"><i class="fa-regular fa-calendar me-2"></i>{{Auth::user()->created_at->format('j-F-Y')}}</h5>
                                
                                <div class="row mt-5">
                                    <div class="col-6">
                                        <a href="{{route('account#editPage')}}" class="d-inline">
